...
int AI::evaluateAlignments(Bitboard& bitboard) {
	...
	PatternInfo mainPatterns[NB_HEURISTIC_PATTERNS] = {
		...
		// {0b11011, 0b00000, 5, 2, 100000},
		// {0b10111, 0b00000, 5, 2, 100000},
		// {0b11101, 0b00000, 5, 2, 100000},
		// {0b11011, 0b00000, 5, 1, -100000},
		// {0b10111, 0b00000, 5, 1, -100000},
		// {0b11101, 0b00000, 5, 1, -100000},
