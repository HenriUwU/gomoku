...
#    Updated: 2024/05/13 14:02:10 by laprieur         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
COMPILER		:=	g++
DEBUG_FLAGS		:=	-Wall -Wextra -Werror -g -MMD -Iinclude -Iinclude/Graphics -Iinclude/Graphics/Game -Iinclude/Graphics/Menu -Iinclude/Algorithm
